"""
Django settings for sinka97 project.
...
WSGI_APPLICATION = 'sinka97.wsgi.application'

# ASGI_APPLICATION = 'django_plotly_dash.routing.application'
# X_FRAME_OPTIONS = 'SAMEORIGIN'  # needed for inter-app iframe inclusion
